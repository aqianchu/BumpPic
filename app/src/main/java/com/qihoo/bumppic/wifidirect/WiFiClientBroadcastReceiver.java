...
public class WiFiClientBroadcastReceiver extends BroadcastReceiver {
    ...
    public WiFiClientBroadcastReceiver(WifiP2pManager manager, Channel channel,ActivitySendPicture activity) {
        ...
        ToastUtils.showShort(activity,"Client Broadcast receiver created");
    }
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (WifiP2pManager.WIFI_P2P_STATE_CHANGED_ACTION.equals(action)) {
            ...
            if (state == WifiP2pManager.WIFI_P2P_STATE_ENABLED) {
                ToastUtils.showShort(activity,"Wifi Direct is enabled");
            	//activity.setClientWifiStatus("Wifi Direct is enabled");
            } else {
                ToastUtils.showShort(activity,"Wifi Direct is not enabled");
        	...
        	if(networkState.isConnected())
        	{
                ...
                ToastUtils.showShort(activity,"Connection Status: Connected");
//        		activity.setClientStatus("Connection Status: Connected");
        	...
        	else
        	{
                ...
                ToastUtils.showShort(activity,"Connection Status: DisConnected");
